const Projects = ({ nav }: { nav: boolean }) => {
  return (
    <div
      id="projects"
    ...
    >
      <div className="max-w-[1500px] mx-auto xl:px-40 lg:px-20 md:px-12 sm:px-8 px-4 p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/solaceChatbot.png)`,
            }}
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="text-center">
                <p className="px-2 py-2">
                  ...
                  chatbot custom-trained on the user&apos;s current page.
                  Leveraged Anthropic&apos;s Claude-3-Sonnet LLM to generate
                  quick responses.
                </p>
              </div>
              <div className="text-center">
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/log_analyzer.png)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/WebScraper.png)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/twoAxisMachine.png)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
            <div className="opacity-0 group-hover:opacity-100">
              <div className="text-center">
                <span className="text-2xl font-bold text-white tracking-wider">
                  STM32 Two-Axis Machine
                </span>
              </div>
              <div className="text-center">
                <p className="px-2 py-2">
                  Developed a control system for a two-axis machine using an
                  STM32 microcontroller, enabling precise control of stepper
                  motors using potentiometers, and limit switches for edges.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Grid Item 5*/}
          <div
            style={{ backgroundImage: `url(/assets/portfolio/BarBot.jpg)` }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
            <div className="opacity-0 group-hover:opacity-100">
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/machinevision.PNG)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/TempSensor.jpg)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/SnackTrack.png)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/SudokuSolver1.png)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/TronDaysRobot.jpg)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
          ...
          <div
            style={{
              backgroundImage: `url(/assets/portfolio/KeychainAssembly.png)`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-div"
          >
            {/*Hover effects*/}
